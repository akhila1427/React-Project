                ...
                <Flex h={16} alignItems={'center'} justifyContent={'space-between'}>
                    ...
                    <HStack spacing={8} alignItems={'center'}>
                        <HStack
                            ...
                            <ReachLink px={2} py={1} rounded={'md'} _hover={{ textDecoration: 'none', bg: 'gray.200' }} to={'/'} ><b>Home</b> </ReachLink>
                            <ReachLink px={2} py={1} rounded={'md'} _hover={{ textDecoration: 'none', bg: 'gray.200' }} to={'/about'}><b> About</b></ReachLink>
                        </HStack>
