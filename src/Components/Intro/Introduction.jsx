import { Flex, Container, Heading, Stack, Text, Button, Box, background } from '@chakra-ui/react';
                        ...
                        selectBtn
                            ...
                            <>
                                ...
                                <Text color={'gray.500'} maxW={'3xl'}>
                                    <b>Resume builder tools that assemble well-formatted resume. Through a resume builder, you can create a professional-looking resume in a few easy steps. This resume builder offer different template options, so you can select the template that best fits your needs and style.</b>
                                </Text>
